...
fn test_insert_chunks_and_lookup() {
    ...
    db.upsert_file_cache("default", "note1.md", "hash1", 1_000, "none", 0, 0, None).unwrap();
...
fn test_delete_chunks_atomic() {
    ...
    db.upsert_file_cache("default", "a.md", "hash_a", 1, "none", 0, 0, None).unwrap();
    db.insert_chunks(&chunks_b).unwrap();
    db.upsert_file_cache("default", "b.md", "hash_b", 2, "none", 0, 0, None).unwrap();
